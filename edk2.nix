# This file is from upstream nixpkgs's edk2/default.nix
# Needed a more recent version than the one in NixOS 22.05.
# TODO: Remove when upgrading to 22.11
{ stdenv
, clangStdenv
, fetchFromGitHub
, fetchpatch
...
edk2 = buildStdenv.mkDerivation {
  ...
  passthru = {
    mkDerivation = projectDscPath: { packages ? [], ...}@attrs: buildStdenv.mkDerivation ({
      inherit (edk2) src;
      ...
      PACKAGES_PATH = lib.concatStringsSep ":" packages;
      ...
      installPhase = ''
        ...
        runHook postInstall
      '';
    } // removeAttrs attrs [ "nativeBuildInputs" "depsBuildBuild" "packages" ]);
  };
};
